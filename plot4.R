...
## Change Voltage to class: Numeric
w1$SVoltage <- as.numeric(w1$Voltage)


## Plotting
png(filename="plot4.png", width=480, height = 480 )
par(mfrow = c(2, 2)) 
# First plot - Global Active power vs. weekday
with(w1, plot(Global_active_power ~ dateTime, type='l', 
              xlab = "", ylab="Global Active Power (kilowatts)" ))
# Second plot - Voltage vs. weekday
with(w1, plot(Voltage ~ dateTime, type='l', 
              xlab="datetime", ylab="Voltage" ))
# Third plot - Energy submetering vs. weekday
...
# Fourth plot - Global Reactive power vs. weekday
with(w1, plot(Global_reactive_power ~ dateTime, type='l', 
